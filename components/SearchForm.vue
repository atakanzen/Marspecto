<template>
  <div>
    ...
    <div v-else class="flex flex-col h-screen space-y-2">
      <Photos :photos="this.currentPhotos" :loading="this.loading" class="static mt-2" />
      <Pagination
        class="static inset-x-0 bottom-0"
